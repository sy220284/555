...
**Fixed:** "Slash input resolves against the visible catalog; the current input-machine contract is summarized in the root `README.md`, with full history available through Git."
