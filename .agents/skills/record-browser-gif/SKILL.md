...
The evidence-chain rationale is summarized in the root `README.md` historical decision index: one storyboard comes from one isolated run, and publication revalidates both the artifact and the demonstrated pull-request head.
