    ...
    public static class AnnihilationPrototype
    {
        ...
        private static void HashTeam(ref ulong hash, PrototypeAnnihilationTeamState team)
        {
            ...
            for (int i = 0; i < team.Units.Count; i++)
            {
                ...
                hash = StateHash64.Add(hash, (int)unit.SupplyLevel);
