...
标准1v1目标：T2 6—10分钟，T3 12—18分钟，T4 20—27分钟，T5 30分钟后。
...
玩家在T4选择两个“主专精槽”。第三条及以后研究成本×1.75、时间×1.5；第四条×2.5、时间×2.0。这样不硬锁内容，但标准对局无法轻易全点。
...
AI不得跳过前置；必须支付相同资源与时间。AI只能依据自身合法情报选择分支，禁止读取未侦察玩家科技。
